...
{
    /// <描述>
    /// 表[otherRes.StoreCheckItems]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    public class StoreCheckItems
    {
        ...
        public DataSet GetDataStoreCheckItemsByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "otherRes.GetDataStoreCheckItemsByNoteID", arParams);
            }
        ...
        public bool InsertStoreCheckItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object CheckQty)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.InsertStoreCheckItems", arParams);
        ...
        public bool UpdateStoreCheckItems(ref string ErrorMsg, object ItemID, object CheckQty)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.UpdateStoreCheckItems", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool DeleteStoreCheckItems(ref string ErrorMsg, object ItemID)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.DeleteStoreCheckItems", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
