    ...
    public class PrdType
    {
        ...
        public bool DeletePrdType(ref string ErrorMsg, object PrdTypeID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.DeletePrdType", arParams);
        ...
        public DataSet GetDataPrdType()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "otherRes.GetDataPrdType");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool GetParmPrdTypeTreePrdTypeName(int PrdTypeID, ref string PrdTypeName)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "otherRes.GetParmPrdTypeTreePrdTypeName", arParams);
        ...
        public DataSet GetDataPrdTypeByParentID(int ParentID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "otherRes.GetDataPrdTypeByParentID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataPrdTypeTree(int ParentID, string Tag, string Prefix)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "otherRes.GetDataPrdTypeTree", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool GetParmPrdTypeID(string PrdTypeName, ref int PrdTypeID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "otherRes.GetParmPrdTypeID", arParams);
        ...
        public bool GetParmPrdTypeIsChildTree(int PrdTypeID, int ParentID, ref bool IsChildTreeFlag)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "otherRes.GetParmPrdTypeIsChildTree", arParams);
        ...
        public bool InsertPrdType(ref string ErrorMsg, ref object PrdTypeID, object PrdTypeName, object ParentID)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.InsertPrdType", arParams);
        ...
        public bool UpdatePrdType(ref string ErrorMsg, object PrdTypeID, object PrdTypeName, object ParentID)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.UpdatePrdType", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
