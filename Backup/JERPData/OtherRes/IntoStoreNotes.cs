...
{
    /// <描述>
    /// 表[otherRes.IntoStoreNotes]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    public class IntoStoreNotes
    {
        ...
        public DataSet GetDataIntoStoreNotesByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "otherRes.GetDataIntoStoreNotesByNoteID", arParams);
            }
        ...
        public DataSet GetDataIntoStoreNotesDescPagesFreeSearch(int PageIndex, int PageSize, ref int RecordCount, string WhereClause)
        {
            DataSet ds = null;
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "otherRes.GetDataIntoStoreNotesDescPagesFreeSearch", arParams);
        ...
        public bool InsertIntoStoreNotes(ref string ErrorMsg, ref object NoteID, ref object NoteCode, object DateNote, object DeptID, object MakerPsnID, object Memo)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.InsertIntoStoreNotes", arParams);
