...
namespace JERPData.Packing
{
    ...
    public class BoxFormat
    {
        ...
        public DataSet GetDataBoxFormat()
        {
            DataSet ds = null;
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "packing.GetDataBoxFormat");
            }
        ...
        public bool SaveBoxFormat(ref string ErrorMsg, object Width, object Height, object Margin, object Offset, object BarcodeName, object BarcodeVersion, object FontSize, object Repeat)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "packing.SaveBoxFormat", arParams);
