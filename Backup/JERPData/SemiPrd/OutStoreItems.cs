    ...
    public class OutStoreItems
    {
        ...
        public DataSet GetDataOutStoreItemsByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "semiprd.GetDataOutStoreItemsByNoteID", arParams);
            }
        ...
        public bool InsertOutStoreItems(ref string ErrorMsg, object NoteID, object WorkingSheetID, object ManufProcessID, object Quantity, object Memo)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "semiprd.InsertOutStoreItems", arParams);
