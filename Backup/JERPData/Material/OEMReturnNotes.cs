...
namespace JERPData.Material
{
    ...
    /// 2014/5/2 12:03:11
    ///</时间>  
    public class OEMReturnNotes
    {
        private SqlConnection sqlConn;
        public OEMReturnNotes()
        {
            this.sqlConn = DBConnection.JSqlDBConn;
        }

        public DataSet GetDataOEMReturnNotesByNoteID(long NoteID)
        {
            DataSet ds = null;
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataOEMReturnNotesByNoteID", arParams);
            }
        ...
        public DataSet GetDataOEMReturnNotesDescPagesFreeSearch(int PageIndex, int PageSize, ref int RecordCount, string WhereClause)
        {
            DataSet ds = null;
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataOEMReturnNotesDescPagesFreeSearch", arParams);
        ...
        public bool InsertOEMReturnNotes(ref string ErrorMsg, ref object NoteID, ref object NoteCode, object DateNote, object CompanyID, object MakerPsnID, object Memo)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertOEMReturnNotes", arParams);
