    ...
    public class StoreCheckItems
    {
        ...
        public bool DeleteStoreCheckItems(ref string ErrorMsg, object ItemID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.DeleteStoreCheckItems", arParams);
        ...
        public DataSet GetDataStoreCheckItemsByNoteID(long NoteID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataStoreCheckItemsByNoteID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertStoreCheckItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object CheckQty)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertStoreCheckItems", arParams);
        ...
        public bool UpdateStoreCheckItems(ref string ErrorMsg, object ItemID, object CheckQty)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.UpdateStoreCheckItems", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
