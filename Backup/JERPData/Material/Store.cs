    ...
    public class Store
    {
        ...
        public DataSet GetDataStoreSafeInventory()
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, "mtr.GetDataStoreSafeInventory");
            }
        ...
        public DataSet GetDataStoreSafeInventoryForPurchase(int PsnID)
        {
            DataSet ds = null;
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataStoreSafeInventoryForPurchase", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
         ...
         public DataSet GetDataStoreInventorySpotTime(DateTime SpotTime, int PrdTypeID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataStoreInventorySpotTime", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataStoreInventoryByBranchStoreID(int BranchStoreID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataStoreInventoryByBranchStoreID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataStoreMonthRpt(int Year, int Month)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataStoreMonthRpt", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataStoreSafeInventoryForManuf()
        {
            DataSet ds = null;
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "mtr.GetDataStoreSafeInventoryForManuf");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataStoreInventory()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "mtr.GetDataStoreInventory");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool GetParmStoreExistsFlag(int PrdID, int BranchStoreID, ref bool ExistFlag)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "mtr.GetParmStoreExistsFlag", arParams);
        ...
        public DataSet GetDataStorePivotBranchStoreID()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "mtr.GetDataStorePivotBranchStoreID");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataStorePrdInventory()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "mtr.GetDataStorePrdInventory");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataStoreRecord(int PrdID, int BranchStoreID, DateTime DateBegin, DateTime DateEnd)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataStoreRecord", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool GetParmStoreDefaultBranchStoreID(int PrdID, ref int BranchStoreID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "mtr.GetParmStoreDefaultBranchStoreID", arParams);
        ...
        public bool GetParmStorePrdAvailableManufInventoryQty(int PrdID, ref decimal AvailableQty)
        {
            bool flag = false;
            SqlParameter[] arParams = new SqlParameter[2];
            arParams[0] = new SqlParameter("@PrdID", SqlDbType.Int);
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "mtr.GetParmStorePrdAvailableManufInventoryQty", arParams);
         ...
         public bool GetParmStoreInventoryPrice(int PrdID, int BranchStoreID, ref decimal InventoryPrice)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "mtr.GetParmStoreInventoryPrice", arParams);
        ...
        public bool GetParmStoreInventoryQty(int PrdID, int BranchStoreID, ref decimal InventoryQty)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "mtr.GetParmStoreInventoryQty", arParams);
        ...
        public bool GetParmStorePrdInventoryQty(int PrdID, ref decimal InventoryQty)
        {
            bool flag = false;
            SqlParameter[] arParams = new SqlParameter[2];
            arParams[0] = new SqlParameter("@PrdID", SqlDbType.Int);
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "mtr.GetParmStorePrdInventoryQty", arParams);
        ...
        public bool GetParmStorePrdAvailableInventoryQty(int PrdID, ref decimal AvailableQty)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "mtr.GetParmStorePrdAvailableInventoryQty", arParams);
                AvailableQty = (decimal)arParams[1].Value;
                flag = true;
            }
            catch//(SqlException ex)
        ...
        public bool InsertStoreForCheckIntoStore(ref string ErrorMsg, object NoteNameID, object NoteID, object NoteCode, object PrdID, object BranchStoreID, object IntoQty, object IntoPrice)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertStoreForCheckIntoStore", arParams);
        ...
        public bool InsertStoreForCheckOutStore(ref string ErrorMsg, object NoteNameID, object NoteID, object NoteCode, object PrdID, object BranchStoreID, object OutQty, object OutPrice)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertStoreForCheckOutStore", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool InsertStoreForInitStore(ref string ErrorMsg, object NoteNameID, object NoteID, object NoteCode, object PrdID, object BranchStoreID, object InitQty, object InitPrice)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertStoreForInitStore", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool InsertStoreForIntoStore(ref string ErrorMsg, object NoteNameID, object NoteID, object NoteCode, object PrdID, object BranchStoreID, object IntoQty, object IntoPrice)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertStoreForIntoStore", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool InsertStoreForOutStore(ref string ErrorMsg, object NoteNameID, object NoteID, object NoteCode, object PrdID, object BranchStoreID, object OutQty, object OutPrice)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertStoreForOutStore", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool UpdateStoreForAppendInventoryAMT(ref string ErrorMsg, object PrdID, object BranchStoreID, object InventoryAMT)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.UpdateStoreForAppendInventoryAMT", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
