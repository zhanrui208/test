    ...
    public class BranchStore
    {
        ...
        public DataSet GetDataBranchStore()
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, "mtr.GetDataBranchStore");
            }
        ...
        public bool InsertBranchStore(ref string ErrorMsg, ref object BranchStoreID, object BranchStoreName, object ValidFlag)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertBranchStore", arParams);
        ...
        public bool UpdateBranchStore(ref string ErrorMsg, object BranchStoreID, object BranchStoreName, object ValidFlag)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.UpdateBranchStore", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool DeleteBranchStore(ref string ErrorMsg, object BranchStoreID)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.DeleteBranchStore", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
