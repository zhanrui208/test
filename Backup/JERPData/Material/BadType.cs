    ...
    public class BadType
    {
        ...
        public bool DeleteBadType(ref string ErrorMsg, object BadTypeID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.DeleteBadType", arParams);
        ...
        public DataSet GetDataBadType()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "mtr.GetDataBadType");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertBadType(ref string ErrorMsg, ref object BadTypeID, object BadTypeCode, object BadTypeName)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertBadType", arParams);
        ...
        public bool UpdateBadType(ref string ErrorMsg, object BadTypeID, object BadTypeCode, object BadTypeName)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.UpdateBadType", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
