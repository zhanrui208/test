    ...
    public class ReportLossNotes
    {
        ...
        public DataSet GetDataReportLossNotesByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataReportLossNotesByNoteID", arParams);
            }
        ...
        public DataSet GetDataReportLossNotesDescPagesFreeSearch(int PageIndex, int PageSize, ref int RecordCount, string WhereClause)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataReportLossNotesDescPagesFreeSearch", arParams);
        ...
        public bool InsertReportLossNotes(ref string ErrorMsg, ref object NoteID, ref object NoteCode, object DateNote, object MakerPsnID, object Memo)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertReportLossNotes", arParams);
