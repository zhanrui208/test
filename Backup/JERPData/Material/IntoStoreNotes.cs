    ...
    public class IntoStoreNotes
    {
        ...
        public DataSet GetDataIntoStoreNotesByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataIntoStoreNotesByNoteID", arParams);
            }
        ...
        public DataSet GetDataIntoStoreNotesDescPagesFreeSearch(int PageIndex, int PageSize, ref int RecordCount, string WhereClause)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataIntoStoreNotesDescPagesFreeSearch", arParams);
        ...
        public bool InsertIntoStoreNotes(ref string ErrorMsg, ref object NoteID, ref object NoteCode, object DateNote, object MakerPsnID, object Memo)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertIntoStoreNotes", arParams);
