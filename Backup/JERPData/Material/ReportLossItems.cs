    ...
    public class ReportLossItems
    {
        ...
        public DataSet GetDataReportLossItemsByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataReportLossItemsByNoteID", arParams);
            }
        ...
        public DataSet GetDataReportLossItemsReport(int Year)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataReportLossItemsReport", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertReportLossItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object BadTypeID, object Quantity, object BranchStoreID, object CostPrice)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertReportLossItems", arParams);
