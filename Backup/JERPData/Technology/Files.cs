    ...
    public class Files
    {
        ...
        public bool DeleteFiles(ref string ErrorMsg, object FileID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tech.DeleteFiles", arParams);
        ...
        public DataSet GetDataFilesByFileTypeID(int FileTypeID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "tech.GetDataFilesByFileTypeID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertFiles(ref string ErrorMsg, ref object FileID, object FileTypeID, object FileCode, object FileName, object Version, object DateCreate, object Memo)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tech.InsertFiles", arParams);
        ...
        public bool UpdateFiles(ref string ErrorMsg, object FileID, object FileCode, object FileName, object Version, object DateCreate, object Memo)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tech.UpdateFiles", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
