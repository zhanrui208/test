    ...
    public class FileType
    {
        ...
        public bool DeleteFileType(ref string ErrorMsg, object FileTypeID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tech.DeleteFileType", arParams);
        ...
        public DataSet GetDataFileType()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "tech.GetDataFileType");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertFileType(ref string ErrorMsg, ref object FileTypeID, object FileTypeCode, object FileTypeName)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tech.InsertFileType", arParams);
        ...
        public bool UpdateFileType(ref string ErrorMsg, object FileTypeID, object FileTypeCode, object FileTypeName)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tech.UpdateFileType", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
