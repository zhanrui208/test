...
{
    /// <描述>
    /// 表[tool.BuyAdvanceAMTRecords]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    public class BuyAdvanceAMTRecords
    {
        ...
        public DataSet GetDataBuyAdvanceAMTRecordsByReceiptNoteID(long ReceiptNoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "tool.GetDataBuyAdvanceAMTRecordsByReceiptNoteID", arParams);
            }
        ...
        public DataSet GetDataBuyAdvanceAMTRecordsDescPagesFreeSearch(int PageIndex, int PageSize, ref int RecordCount, string WhereClause)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "tool.GetDataBuyAdvanceAMTRecordsDescPagesFreeSearch", arParams);
        ...
        public DataSet GetDataBuyAdvanceAMTRecordsForReceipt(int CompanyID, int MoneyTypeID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "tool.GetDataBuyAdvanceAMTRecordsForReceipt", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool GetParmBuyAdvanceAMTRecordsReceiptFlag(int CompanyID, int MoneyTypeID, ref bool Flag)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "tool.GetParmBuyAdvanceAMTRecordsReceiptFlag", arParams);
        ...
        public bool InsertBuyAdvanceAMTRecords(ref string ErrorMsg, object DateRecord, object BuyOrderNoteID, object CompanyID, object MoneyTypeID, object Amount, object MakerPsnID, object Memo)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tool.InsertBuyAdvanceAMTRecords", arParams);
        ...
        public bool UpdateBuyAdvanceAMTRecordsForReceipt(ref string ErrorMsg, object RecordID, object ReceiptNoteID)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tool.UpdateBuyAdvanceAMTRecordsForReceipt", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
