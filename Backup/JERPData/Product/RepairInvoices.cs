...
namespace JERPData.Product
{
    ...
    public class RepairInvoices
    {
        ...
        public bool DeleteRepairInvoices(ref string ErrorMsg, object InvoiceID)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.DeleteRepairInvoices", arParams);
        ...
        public DataSet GetDataRepairInvoicesByInvoiceID(long InvoiceID)
        {
            DataSet ds = null;
            SqlParameter[] arParams = new SqlParameter[1];
            arParams[0] = new SqlParameter("@InvoiceID", SqlDbType.BigInt);
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataRepairInvoicesByInvoiceID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataRepairInvoicesDescPagesFreeSearch(int PageIndex, int PageSize, ref int RecordCount, string WhereClause)
        {
            DataSet ds = null;
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataRepairInvoicesDescPagesFreeSearch", arParams);
        ...
        public DataSet GetDataRepairInvoicesNonConfirm()
        {
            DataSet ds = null;
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "prd.GetDataRepairInvoicesNonConfirm");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool GetParmRepairInvoicesInvoiceID(int Year, int Month, int CompanyID, int FinanceAddressID, int MoneyTypeID, int InvoiceTypeID, ref long InvoiceID)
        {
            bool flag = false;
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "prd.GetParmRepairInvoicesInvoiceID", arParams);
        ...
        public bool InsertRepairInvoices(ref string ErrorMsg, ref object InvoiceID, object InvoiceName, object Year, object Month, object DateNote, object CompanyID, object FinanceAddressID, object MoneyTypeID, object InvoiceTypeID, object MakerPsnID)
        {
            bool flag = false;
            ErrorMsg = string.Empty;
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.InsertRepairInvoices", arParams);
        ...
        public bool UpdateRepairInvoices(ref string ErrorMsg, object InvoiceID, object InvoiceName, object TotalAMT, object TaxAMT, object MakerPsnID)
        {
            bool flag = false;
            ErrorMsg = string.Empty;
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.UpdateRepairInvoices", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool UpdateRepairInvoicesForConfirm(ref string ErrorMsg, object InvoiceID, object ConfirmPsnID)
        {
            bool flag = false;
            ErrorMsg = string.Empty;
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.UpdateRepairInvoicesForConfirm", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool UpdateRepairInvoicesForTotalAMT(ref string ErrorMsg, object InvoiceID, object TotalAMT, object TaxAMT)
        {
            bool flag = false;
            ErrorMsg = string.Empty;
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.UpdateRepairInvoicesForTotalAMT", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
