    ...
    public class BuyBadReportItems
    {
        ...
        public bool DeleteBuyBadReportItems(ref string ErrorMsg, object ItemID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.DeleteBuyBadReportItems", arParams);
        ...
        public DataSet GetDataBuyBadReportItemsForSetting(long NoteID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataBuyBadReportItemsForSetting", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataBuyBadReportItemsPrdQtyPivotBadTypeBetweenDate(DateTime DateBegin, DateTime DateEnd)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataBuyBadReportItemsPrdQtyPivotBadTypeBetweenDate", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataBuyBadReportItemsPrdRptPivotCompanyBetweenDate(DateTime DateBegin, DateTime DateEnd)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataBuyBadReportItemsPrdRptPivotCompanyBetweenDate", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertBuyBadReportItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object Quantity, object BadQty)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.InsertBuyBadReportItems", arParams);
        ...
        public bool UpdateBuyBadReportItems(ref string ErrorMsg, object ItemID, object PrdID, object Quantity, object BadQty)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.UpdateBuyBadReportItems", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
