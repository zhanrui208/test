...
{
    /// <描述>
    /// 表[prd.RepairInvoiceFormat]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    /// 2010-1-17 22:29:38
    ///</时间>  
    public class RepairInvoiceFormat
    {
        private SqlConnection sqlConn;
        public RepairInvoiceFormat()
        {
            this.sqlConn = DBConnection.JSqlDBConn;
        }
        public DataSet GetDataRepairInvoiceFormat()
        {
            DataSet ds = null;
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "prd.GetDataRepairInvoiceFormat");
            }
        ...
        public DataSet GetDataRepairInvoiceFormatByFormatID(int  FormatID)
        {
            DataSet ds = null;
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataRepairInvoiceFormatByFormatID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataRepairInvoiceFormatByCompanyID(int CompanyID)
        {
            DataSet ds = null;
            SqlParameter[] arParams = new SqlParameter[1];
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataRepairInvoiceFormatByCompanyID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertRepairInvoiceFormat(ref string ErrorMsg, ref object FormatID, object TmpSheetName, object InvoiceCodeCellName, object InvoiceNameCellName, object CompanyNameCellName, object FinanceAddressCellName, object MoneyTypeCellName, object InvoiceTypeCellName, object LinkmanCellName, object TelephoneCellName, object FaxCellName, object DateNoteCellName, object TotalQtyCellName, object TotalAMTCellName, object TaxAMTCellName, object ItemBeginRowIndex)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.InsertRepairInvoiceFormat", arParams);
        ...
        public bool InsertRepairInvoiceFormatFromCopy(ref string ErrorMsg, object OldFormatID, object TmpSheetName)
        {
            bool flag = false;
            ErrorMsg = string.Empty;
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.InsertRepairInvoiceFormatFromCopy", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool UpdateRepairInvoiceFormat(ref string ErrorMsg, object FormatID, object TmpSheetName, object InvoiceCodeCellName, object InvoiceNameCellName, object CompanyNameCellName, object FinanceAddressCellName, object MoneyTypeCellName, object InvoiceTypeCellName, object LinkmanCellName, object TelephoneCellName, object FaxCellName, object DateNoteCellName, object TotalQtyCellName, object TotalAMTCellName, object TaxAMTCellName, object ItemBeginRowIndex)
        {
            bool flag = false;
            ErrorMsg = string.Empty;
            SqlParameter[] arParams = new SqlParameter[16];
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.UpdateRepairInvoiceFormat", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool DeleteRepairInvoiceFormat(ref string ErrorMsg, object FormatID)
        {
            bool flag = false;
            ErrorMsg = string.Empty;
            SqlParameter[] arParams = new SqlParameter[1];
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.DeleteRepairInvoiceFormat", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
