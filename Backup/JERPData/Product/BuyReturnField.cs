    ...
    public class BuyReturnField
    {
        ...
        public bool DeleteBuyReturnField(ref string ErrorMsg, object FieldID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.DeleteBuyReturnField", arParams);
        ...
        public DataSet GetDataBuyReturnField()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "prd.GetDataBuyReturnField");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertBuyReturnField(ref string ErrorMsg, ref object FieldID, object FieldName, object FieldCaption)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.InsertBuyReturnField", arParams);
        ...
        public bool UpdateBuyReturnField(ref string ErrorMsg, object FieldID, object FieldName, object FieldCaption)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.UpdateBuyReturnField", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
