...
{
    public partial class CtrlIndivPieceworkQuantityRpt : UserControl
    {
        public CtrlIndivPieceworkQuantityRpt()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            this.dtblReport = this.accIndivPiecework.GetDataIndivPieceworkQuantityPivotProcessType(this.DateBegin ,this.DateEnd).Tables[0];
