...
{
    public partial class CtrlGroupPieceworkLaborWageRpt : UserControl
    {
        public CtrlGroupPieceworkLaborWageRpt()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            this.dtblReport = this.accGroupPiecework.GetDataGroupPieceworkItemsLaborWagePivotProcessType(this.DateBegin ,this.DateEnd).Tables[0];
