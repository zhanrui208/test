...
namespace JERPApp.Define.Finance
{
    ...
    /// 2015-01-15 09:37:17
    ///</时间> 
    public partial class CtrlOtherRevenueType : UserControl
    {
        public CtrlOtherRevenueType()
        {
            InitializeComponent();
        ...
        {
            this.dtblRevenueType = this.accDataRevenueType.GetDataRevenueTypeByLockFlag (false).Tables[0];
