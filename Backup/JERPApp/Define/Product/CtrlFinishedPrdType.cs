...
namespace JERPApp.Define.Product
{
    ...
    /// 2014/3/26 8:42:46
    ///</时间> 
    public partial class CtrlFinishedPrdType : UserControl
    {
        public CtrlFinishedPrdType()
        {
            InitializeComponent();
        ...
        {
            this.dtblPrdType = this.accDataPrdType.GetDataPrdTypeForFinishedPrd ().Tables[0];
