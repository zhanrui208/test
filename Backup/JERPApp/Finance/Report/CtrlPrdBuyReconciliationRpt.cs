...
{
    public partial class CtrlPrdBuyReconciliationRpt : UserControl
    {
        public CtrlPrdBuyReconciliationRpt()
        {
            InitializeComponent();
            this.dgrdv.AutoGenerateColumns = false;
            this.accReconcilaiton = new JERPData.Product .BuyReconciliations();
        ...
        private JERPData.Product.BuyReconciliations accReconcilaiton;
