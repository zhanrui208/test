...
{
    public partial class CtrlOutSrcReconciliationRpt : UserControl
    {
        public CtrlOutSrcReconciliationRpt()
        {
            InitializeComponent();
            this.dgrdv.AutoGenerateColumns = false;
            this.accReconcilaiton = new JERPData.Manufacture.OutSrcReconciliations();
        ...
        private JERPData.Manufacture.OutSrcReconciliations accReconcilaiton;
        ...
        {
            this.dtblRpt = this.accReconcilaiton.GetDataOutSrcReconciliationsYearReport(this.Year).Tables[0];
        ...
        void btnExplore_Click(object sender, EventArgs e)
        {
            ...
            excel.SetCellVal("A1", Year.ToString() + "年外发对账表");
            int rowIndex = 4;
            int colIndex = 1;
