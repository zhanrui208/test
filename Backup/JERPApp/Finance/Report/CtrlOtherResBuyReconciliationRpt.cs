...
{
    public partial class CtrlOtherResBuyReconciliationRpt : UserControl
    {
        public CtrlOtherResBuyReconciliationRpt()
        {
            InitializeComponent();
            this.dgrdv.AutoGenerateColumns = false;
            this.accReconcilaiton = new JERPData.OtherRes.BuyReconciliations();
        ...
        private JERPData.OtherRes.BuyReconciliations accReconcilaiton;
        ...
        {
            this.dtblRpt = this.accReconcilaiton.GetDataBuyReconciliationsYearReport(this.Year).Tables[0];
        ...
        void btnExplore_Click(object sender, EventArgs e)
        {
            ...
            excel.SetCellVal("A1", Year.ToString() + "年包材对账表");
            int rowIndex = 4;
            int colIndex = 1;
