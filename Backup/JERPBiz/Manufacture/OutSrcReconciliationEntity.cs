...
namespace JERPBiz.Manufacture
{
    ...
    /// 2016/5/8 16:00:45
    ///</时间>  
    public class OutSrcReconciliationEntity
    {
        public OutSrcReconciliationEntity()
        {
            this.accData = new JERPData.Manufacture.OutSrcReconciliations();
        }
        private JERPData.Manufacture.OutSrcReconciliations accData;
        ...
        public long OutSrcOrderNoteID = -1;
        public int OutSrcOrderSerialNo = -1;
        ...
        public decimal LossSupplyAMT = 0;
        ...
        public void LoadData(long ReconciliationID)
        {
            ...
            DataTable dtbl = this.accData.GetDataOutSrcReconciliationsByReconciliationID(ReconciliationID).Tables[0];
            ...
            if (drow["OutSrcOrderNoteID"] == DBNull.Value)
            {
                this.OutSrcOrderNoteID = -1;
            }
            else
            {
                this.OutSrcOrderNoteID = (long)drow["OutSrcOrderNoteID"];
            }
            if (drow["OutSrcOrderSerialNo"] == DBNull.Value)
            {
                this.OutSrcOrderSerialNo = -1;
            }
            else
            {
                this.OutSrcOrderSerialNo = (int)drow["OutSrcOrderSerialNo"];
            }
            ...
            if (drow["LossSupplyAMT"] == DBNull.Value)
            {
                this.LossSupplyAMT = 0;
            }
            else
            {
                this.LossSupplyAMT = (decimal)drow["LossSupplyAMT"];
            }
