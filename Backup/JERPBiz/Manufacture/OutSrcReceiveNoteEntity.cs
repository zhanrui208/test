...
namespace JERPBiz.Manufacture
{
    ...
    /// 2016/1/18 9:58:10
    ///</时间>  
    public class OutSrcReceiveNoteEntity
    {
        public OutSrcReceiveNoteEntity()
        {
            this.accData = new JERPData.Manufacture.OutSrcReceiveNotes();
        }
        private JERPData.Manufacture.OutSrcReceiveNotes accData;
        ...
        {
            this.NoteID = NoteID;
            DataTable dtbl = this.accData.GetDataOutSrcReceiveNotesByNoteID(NoteID).Tables[0];
