...
namespace JERPBiz.Manufacture
{
    ...
    /// 2015/7/19 16:16:37
    ///</时间>  
    public class OutSrcInvoiceEntity
    {
        public OutSrcInvoiceEntity()
        {
            this.accData = new JERPData.Manufacture.OutSrcInvoices();
        }
        private JERPData.Manufacture.OutSrcInvoices accData;
        ...
        public void LoadData(long InvoiceID)
        {
            ...
            DataTable dtbl = this.accData.GetDataOutSrcInvoicesByInvoiceID(InvoiceID).Tables[0];
