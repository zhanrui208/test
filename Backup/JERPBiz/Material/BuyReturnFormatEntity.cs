...
namespace JERPBiz.Material
{
    ...
    /// 2015-04-03 10:55:25
    ///</时间>  
    public class BuyReturnFormatEntity
    {
        public BuyReturnFormatEntity()
        {
            this.accData = new JERPData.Material.BuyReturnFormat();
        }
        private JERPData.Material.BuyReturnFormat accData;
        ...
        public string AddressCellName = string.Empty;
        ...
        public void LoadData(int FormatID)
        {
            ...
            DataTable dtbl = this.accData.GetDataBuyReturnFormatByFormatID(FormatID).Tables[0];
            if (dtbl.Rows.Count == 0)
            {
                ...
                this.AddressCellName = string.Empty;
            ...
            if (drow["AddressCellName"] == DBNull.Value)
            {
                this.AddressCellName = string.Empty;
            }
            else
            {
                this.AddressCellName = drow["AddressCellName"].ToString();
            }
