...
namespace JERPBiz.Material
{
    ...
    /// 2014/5/3 10:11:26
    ///</时间>  
    public class OEMReturnNoteEntity
    {
        public OEMReturnNoteEntity()
        {
            this.accData = new JERPData.Material.OEMReturnNotes();
        }
        private JERPData.Material.OEMReturnNotes accData;
        ...
        {
            this.NoteID = NoteID;
            DataTable dtbl = this.accData.GetDataOEMReturnNotesByNoteID(NoteID).Tables[0];
