...
namespace JERPBiz.Material
{
    ...
    /// 2015/12/1 19:22:45
    ///</时间>  
    public class OutSrcStoreCheckNoteEntity
    {
        public OutSrcStoreCheckNoteEntity()
        {
            this.accData = new JERPData.Material.OutSrcStoreCheckNotes();
        }
        private JERPData.Material.OutSrcStoreCheckNotes accData;
        ...
        {
            this.NoteID = NoteID;
            DataTable dtbl = this.accData.GetDataOutSrcStoreCheckNotesByNoteID(NoteID).Tables[0];
