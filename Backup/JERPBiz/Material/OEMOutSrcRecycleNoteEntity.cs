...
namespace JERPBiz.Material
{
    ...
    /// 2014/5/13 21:30:48
    ///</时间>  
    public class OEMOutSrcRecycleNoteEntity
    {
        public OEMOutSrcRecycleNoteEntity()
        {
            this.accData = new JERPData.Material.OEMOutSrcRecycleNotes();
        }
        private JERPData.Material.OEMOutSrcRecycleNotes accData;
        ...
        {
            this.NoteID = NoteID;
            DataTable dtbl = this.accData.GetDataOEMOutSrcRecycleNotesByNoteID(NoteID).Tables[0];
