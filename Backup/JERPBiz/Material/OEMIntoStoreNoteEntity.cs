...
namespace JERPBiz.Material
{
    ...
    /// 2014/5/2 17:42:10
    ///</时间>  
    public class OEMIntoStoreNoteEntity
    {
        public OEMIntoStoreNoteEntity()
        {
            this.accData = new JERPData.Material.OEMIntoStoreNotes();
        }
        private JERPData.Material.OEMIntoStoreNotes accData;
        ...
        {
            this.NoteID = NoteID;
            DataTable dtbl = this.accData.GetDataOEMIntoStoreNotesByNoteID(NoteID).Tables[0];
