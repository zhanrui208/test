...
namespace JERPBiz.Material
{
    public class BuyOrderNotePrintHelper
    {
        public BuyOrderNotePrintHelper()
        {
            ...
            this.accFormatTitle = new JERPData.Material.BuyOrderFieldTitle();
            this.FormatEntity = new BuyOrderFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "MtrBuyOrderNote.xlt";
        ...
        private JERPData.Material.BuyOrderFormat accFormat;
        private JERPData.Material.BuyOrderFieldTitle accFormatTitle;
