...
{
    public class OEMOutStoreNotePrintHelper
    {
        public OEMOutStoreNotePrintHelper()
        { 
            this.accFormatTitle = new JERPData.Material.OEMOutStoreFieldTitle(); 
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "MtrOEMOutStoreNote.xlt";
         
            
        } 
        private JERPData.Material.OEMOutStoreFieldTitle accFormatTitle; 
        private string TmpFileName = string.Empty; 
        public void ExportToExcel(DataRow[] drowItems)
        {
            DataTable dtblColumns = this.accFormatTitle.GetDataOEMOutStoreFieldTitle ().Tables[0];
