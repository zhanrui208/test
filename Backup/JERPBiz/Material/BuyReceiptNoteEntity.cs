...
namespace JERPBiz.Material
{
    ...
    /// 2016/1/18 22:44:06
    ///</时间>  
    public class BuyReceiptNoteEntity
    {
        public BuyReceiptNoteEntity()
        {
            this.accData = new JERPData.Material.BuyReceiptNotes();
        }
        private JERPData.Material.BuyReceiptNotes accData;
        ...
        {
            this.NoteID = NoteID;
            DataTable dtbl = this.accData.GetDataBuyReceiptNotesByNoteID(NoteID).Tables[0];
