...
namespace JERPBiz.Product
{
    ...
    /// 2015/9/3 22:20:05
    ///</时间>  
    public class SaleDeliverFormatEntity
    {
        public SaleDeliverFormatEntity()
        {
            this.accData = new JERPData.Product.SaleDeliverFormat();
        }
        private JERPData.Product.SaleDeliverFormat accData;
        ...
        public void LoadData(int FormatID)
        {
            ...
            DataTable dtbl = this.accData.GetDataSaleDeliverFormatByFormatID(FormatID).Tables[0];
