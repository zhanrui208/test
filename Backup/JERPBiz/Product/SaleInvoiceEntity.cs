...
namespace JERPBiz.Product
{
    ...
    public class SaleInvoiceEntity
    {
        ...
        {
            this.accData = new JERPData.Product.SaleInvoices();
        }
        private JERPData.Product.SaleInvoices accData;
        ...
        public void LoadData(long InvoiceID)
        {
            ...
            DataTable dtbl = this.accData.GetDataSaleInvoicesByInvoiceID(InvoiceID).Tables[0];
