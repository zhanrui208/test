...
namespace JERPBiz.Packing
{
    ...
    public class WorkingSheetEntity
    {
        ...
        {
            this.accData = new JERPData.Packing.WorkingSheets();
        }
        private JERPData.Packing.WorkingSheets accData;
        ...
        public void LoadData(long WorkingSheetID)
        {
            ...
            if (drow["PackingPlanID"] == DBNull.Value)
            {
                this.PackingPlanID = -1;
            }
            else
            {
                this.PackingPlanID = (long)drow["PackingPlanID"];
            }
