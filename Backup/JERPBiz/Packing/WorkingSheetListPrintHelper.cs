...
namespace JERPBiz.Packing
{
    public class WorkingSheetListPrintHelper
    {
        ...
        {  
            ...
            this.accFormatTitle = new JERPData.Packing.WorkingSheetListFieldTitle();
            this.FormatEntity = new WorkingSheetListFormatEntity(); 
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "PackingSheetList.xlt"; 
            
        } 
        private JERPData.Packing.WorkingSheetListFormat accFormat;
        private JERPData.Packing.WorkingSheetListFieldTitle accFormatTitle; 
