...
namespace JERPBiz.Packing
{
    ...
    /// 2015/11/30 9:59:24
    ///</时间>  
    public class BoxItemFormatEntity
    {
        public BoxItemFormatEntity()
        {
            this.accData = new JERPData.Packing.BoxItemFormat();
        }
        private JERPData.Packing.BoxItemFormat accData;
        ...
        public void LoadData()
        {
            ...
            DataTable dtbl = this.accData.GetDataBoxItemFormat().Tables[0];
