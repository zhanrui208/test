    ...
    public class BuyOrderField
    {
        ...
        public bool DeleteBuyOrderField(ref string ErrorMsg, object FieldID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.DeleteBuyOrderField", arParams);
        ...
        public DataSet GetDataBuyOrderField()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "mtr.GetDataBuyOrderField");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertBuyOrderField(ref string ErrorMsg, ref object FieldID, object FieldName, object FieldCaption)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertBuyOrderField", arParams);
        ...
        public bool UpdateBuyOrderField(ref string ErrorMsg, object FieldID, object FieldName, object FieldCaption)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.UpdateBuyOrderField", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
