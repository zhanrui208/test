...
namespace JERPData.Material
{
    ...
    /// 2014/4/3 16:51:55
    ///</时间>  
    public class BuyReplenishItems
    {
        private SqlConnection sqlConn;
        public BuyReplenishItems()
        {
            this.sqlConn = DBConnection.JSqlDBConn;
        }

        public DataSet GetDataBuyReplenishItemsByNoteID(long NoteID)
        {
            DataSet ds = null;
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataBuyReplenishItemsByNoteID", arParams);
            }
        ...
        public bool InsertBuyReplenishItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object Quantity, object BranchStoreID, object CostPrice)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertBuyReplenishItems", arParams);
