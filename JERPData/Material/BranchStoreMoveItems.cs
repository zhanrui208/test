...
{
    /// <描述>
    /// 表[mtr.BranchStoreMoveItems]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    public class BranchStoreMoveItems
    {
        ...
        public DataSet GetDataBranchStoreMoveItemsByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataBranchStoreMoveItemsByNoteID", arParams);
            }
        ...
        public bool InsertBranchStoreMoveItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object Quantity, object CostPrice)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertBranchStoreMoveItems", arParams);
