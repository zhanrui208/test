    ...
    public class OutStoreNotes
    {
        ...
        public DataSet GetDataOutStoreNotesByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataOutStoreNotesByNoteID", arParams);
            }
        ...
        public DataSet GetDataOutStoreNotesDescPagesFreeSearch(int PageIndex, int PageSize, ref int RecordCount, string WhereClause)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataOutStoreNotesDescPagesFreeSearch", arParams);
        ...
        public bool InsertOutStoreNotes(ref string ErrorMsg, ref object NoteID, ref object NoteCode, object DateNote, object MakerPsnID, object Memo)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertOutStoreNotes", arParams);
