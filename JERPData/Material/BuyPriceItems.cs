    ...
    public class BuyPriceItems
    {
        ...
        public bool DeleteBuyPriceItems(ref string ErrorMsg, object ItemID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.DeleteBuyPriceItems", arParams);
        ...
        public DataSet GetDataBuyPriceItemsPivotSupplier(int MoneyTypeID, int SettleTypeID, int PriceTypeID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataBuyPriceItemsPivotSupplier", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataBuyPriceItemsByNoteID(long NoteID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataBuyPriceItemsByNoteID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataBuyPriceItemsPivotDateNote(int CompanyID, int MoneyTypeID, int SettleTypeID, int PriceTypeID, DateTime DateFrom)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataBuyPriceItemsPivotDateNote", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool GetParmBuyPriceItemsPrice(int CompanyID, int MoneyTypeID, int SettleTypeID, int PriceTypeID, DateTime DateCurrent, int PrdID, ref decimal Price)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "mtr.GetParmBuyPriceItemsPrice", arParams);
        ...
        public bool InsertBuyPriceItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object Price, object Memo)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.InsertBuyPriceItems", arParams);
        ...
        public bool UpdateBuyPriceItems(ref string ErrorMsg, object ItemID, object PrdID, object Price, object Memo)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.UpdateBuyPriceItems", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
