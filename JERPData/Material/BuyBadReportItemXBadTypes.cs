...
{
    /// <描述>
    /// 表[mtr.BuyBadReportItemXBadTypes]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    public class BuyBadReportItemXBadTypes
    {
        ...
        public DataSet GetDataBuyBadReportItemXBadTypesBadTypesByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "mtr.GetDataBuyBadReportItemXBadTypesBadTypesByNoteID", arParams);
            }
        ...
        public bool DeleteBuyBadReportItemXBadTypes(ref string ErrorMsg, object ItemID, object BadTypeID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.DeleteBuyBadReportItemXBadTypes", arParams);
        ...
        public bool SaveBuyBadReportItemXBadTypes(ref string ErrorMsg, object ItemID, object BadTypeID, object Quantity)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "mtr.SaveBuyBadReportItemXBadTypes", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
