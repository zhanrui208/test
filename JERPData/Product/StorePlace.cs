    ...
    public class StorePlace
    {
        ...
        public bool GetParmStorePlace(int BranchStoreID, int PrdID, ref string Place)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(this.sqlConn, CommandType.StoredProcedure, "prd.GetParmStorePlace", arParams);
        ...
        public DataSet GetDataStorePlaceForSetting(int PrdTypeID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataStorePlaceForSetting", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataStorePlaceByBranchStoreID(int BranchStoreID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataStorePlaceByBranchStoreID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool SaveStorePlace(ref string ErrorMsg, object BranchStoreID, object PrdID, object Place)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.SaveStorePlace", arParams);
        ...
        public bool DeleteStorePlace(ref string ErrorMsg, object BranchStoreID, object PrdID)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.DeleteStorePlace", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
