    ...
    public class BuyReceiveField
    {
        ...
        public bool DeleteBuyReceiveField(ref string ErrorMsg, object FieldID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.DeleteBuyReceiveField", arParams);
        ...
        public DataSet GetDataBuyReceiveField()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "prd.GetDataBuyReceiveField");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertBuyReceiveField(ref string ErrorMsg, ref object FieldID, object FieldName, object FieldCaption)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.InsertBuyReceiveField", arParams);
        ...
        public bool UpdateBuyReceiveField(ref string ErrorMsg, object FieldID, object FieldName, object FieldCaption)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.UpdateBuyReceiveField", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
