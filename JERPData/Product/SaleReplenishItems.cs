...
{
    /// <描述>
    /// 表[prd.SaleReplenishItems]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    /// 2013-02-15 10:59:40
    ///</时间>  
    public class SaleReplenishItems
    {
        private SqlConnection sqlConn;
        public SaleReplenishItems()
        {
            this.sqlConn = DBConnection.JSqlDBConn;
        }


        public DataSet GetDataSaleReplenishItemsByNoteID(long NoteID)
        {
            DataSet ds = null;
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "prd.GetDataSaleReplenishItemsByNoteID", arParams);
            }
        ...
        public bool InsertSaleReplenishItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object Quantity, object CostPrice, object BranchStoreID, object Memo)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "prd.InsertSaleReplenishItems", arParams);
