    ...
    public class SafeStore
    {
        ...
        public DataSet GetDataSafeStoreForSetting(int Year)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "otherRes.GetDataSafeStoreForSetting", arParams);
            }
        ...
        public bool SaveSafeStore(ref string ErrorMsg, object PrdID, object SafeStoreQty)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.SaveSafeStore", arParams);
