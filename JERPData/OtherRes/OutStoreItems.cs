...
{
    /// <描述>
    /// 表[otherRes.OutStoreItems]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    public class OutStoreItems
    {
        ...
        public DataSet GetDataOutStoreItemsByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "otherRes.GetDataOutStoreItemsByNoteID", arParams);
            }
        ...
        public bool InsertOutStoreItems(ref string ErrorMsg, ref object ItemID, object NoteID, object PrdID, object Quantity, object BranchStoreID, object CostPrice, object Memo)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "otherRes.InsertOutStoreItems", arParams);
