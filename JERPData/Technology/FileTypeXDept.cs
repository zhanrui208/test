    ...
    public class FileTypeXDept
    {
        ...
        public DataSet GetDataFileTypeXDeptByFileTypeID(int FileTypeID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "tech.GetDataFileTypeXDeptByFileTypeID", arParams);
            }
        ...
        public DataSet GetDataFileTypeXDeptPivotDept()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "tech.GetDataFileTypeXDeptPivotDept");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool DeleteFileTypeXDept(ref string ErrorMsg, object FileTypeID, object DeptID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tech.DeleteFileTypeXDept", arParams);
        ...
        public bool SaveFileTypeXDept(ref string ErrorMsg, object FileTypeID, object DeptID)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tech.SaveFileTypeXDept", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
