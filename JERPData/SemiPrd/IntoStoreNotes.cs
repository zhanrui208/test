...
{
    /// <描述>
    /// 表[semiprd.IntoStoreNotes]数据访问类
    ///</描述> 
    ///<作者> 
    /// 金优富
    ///</作者> 
    ...
    public class IntoStoreNotes
    {
        ...
        public DataSet GetDataIntoStoreNotesByNoteID(long NoteID)
        {
            ...
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "semiprd.GetDataIntoStoreNotesByNoteID", arParams);
            }
        ...
        public DataSet GetDataIntoStoreNotesDescPagesFreeSearch(int PageIndex, int PageSize, ref int RecordCount, string WhereClause)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "semiprd.GetDataIntoStoreNotesDescPagesFreeSearch", arParams);
        ...
        public bool InsertIntoStoreNotes(ref string ErrorMsg, ref object NoteID, object DateNote, object MakerPsnID, object Memo)
        {
            bool flag = false;
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "semiprd.InsertIntoStoreNotes", arParams);
