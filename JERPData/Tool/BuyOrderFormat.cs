    ...
    public class BuyOrderFormat
    {
        ...
        public bool DeleteBuyOrderFormat(ref string ErrorMsg, object FormatID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tool.DeleteBuyOrderFormat", arParams);
        ...
        public DataSet GetDataBuyOrderFormat()
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, "tool.GetDataBuyOrderFormat");
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public DataSet GetDataBuyOrderFormatByFormatID(int FormatID)
        {
            ...
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                ds = SqlHelper.ExecuteDataset(sqlConn, CommandType.StoredProcedure, "tool.GetDataBuyOrderFormatByFormatID", arParams);
            }
            catch//(SqlException ex)
            {
                // ex.Message --这里作调试用
        ...
        public bool InsertBuyOrderFormat(ref string ErrorMsg, ref object FormatID, object TmpSheetName, object NoteCodeCellName, object DateNoteCellName, object CompanyNameCellName, object LegalPersonCellName, object LinkmanCellName, object TelephoneCellName, object FaxCellName, object SupplierAddressCellName, object DeliverAddressCellName, object DeliverTypeCellName, object ExpressRequireCellName, object MoneyTypeCellName, object SettleTypeCellName, object PriceTypeCellName, object InvoiceTypeCellName, object MakerPsnCellName, object ConfirmPsnCellName, object MemoCellName, object ItemRowIndex, object ItemRowCount)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tool.InsertBuyOrderFormat", arParams);
        ...
        public bool InsertBuyOrderFormatFromCopy(ref string ErrorMsg, object OldFormatID, object TmpSheetName)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tool.InsertBuyOrderFormatFromCopy", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
        ...
        public bool UpdateBuyOrderFormat(ref string ErrorMsg, object FormatID, object TmpSheetName, object NoteCodeCellName, object DateNoteCellName, object CompanyNameCellName, object LegalPersonCellName, object LinkmanCellName, object TelephoneCellName, object FaxCellName, object SupplierAddressCellName, object DeliverAddressCellName, object DeliverTypeCellName, object ExpressRequireCellName, object MoneyTypeCellName, object SettleTypeCellName, object PriceTypeCellName, object InvoiceTypeCellName, object MakerPsnCellName, object ConfirmPsnCellName, object MemoCellName, object ItemRowIndex, object ItemRowCount)
        {
            ...
            try
            {
                if (this.sqlConn.State == System.Data.ConnectionState.Closed) this.sqlConn.Open();
                DBTransaction = this.sqlConn.BeginTransaction();
                SqlHelper.ExecuteNonQuery(DBTransaction, CommandType.StoredProcedure, "tool.UpdateBuyOrderFormat", arParams);
                DBTransaction.Commit();
                flag = true;
            }
            catch (SqlException ex)
