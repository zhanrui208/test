...
namespace JERPBiz.Manufacture
{
    ...
    /// 2015-01-08 14:58:31
    ///</时间>  
    public class OutSrcFineAMTNoteEntity
    {
        public OutSrcFineAMTNoteEntity()
        {
            this.accData = new JERPData.Manufacture.OutSrcFineAMTNotes();
        }
        private JERPData.Manufacture.OutSrcFineAMTNotes accData;
        ...
        {
            this.NoteID = NoteID;
            DataTable dtbl = this.accData.GetDataOutSrcFineAMTNotesByNoteID(NoteID).Tables[0];
