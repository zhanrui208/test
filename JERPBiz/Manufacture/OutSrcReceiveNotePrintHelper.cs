...
{
    public class OutSrcReceiveNotePrintHelper
    {
        public OutSrcReceiveNotePrintHelper()
        {
            this.NoteEntity = new OutSrcReceiveNoteEntity();
            this.accItems = new JERPData.Manufacture.OutSrcReceiveItems();
            this.accFormat = new JERPData.Manufacture.OutSrcReceiveFormat();
            this.accFormatTitle = new JERPData.Manufacture.OutSrcReceiveFieldTitle();
            this.FormatEntity = new OutSrcReceiveFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "OutSrcReceiveNote.xlt";
         
            
        }
        private JERPBiz.Manufacture .OutSrcReceiveNoteEntity   NoteEntity;
        private JERPData.Manufacture.OutSrcReceiveItems accItems;
        private JERPData.Manufacture.OutSrcReceiveFormat accFormat;
        private JERPData.Manufacture.OutSrcReceiveFieldTitle accFormatTitle;
        private OutSrcReceiveFormatEntity FormatEntity;
        private string TmpFileName = string.Empty;
        
        public void ExportToExcel(long NoteID)
        {
            DataTable dtblFormat = this.accFormat.GetDataOutSrcReceiveFormat().Tables[0];
            ...
            DataTable dtblItems = this.accItems.GetDataOutSrcReceiveItemsByNoteID(NoteID).Tables[0];           
            ...
            DataTable dtblColumns = this.accFormatTitle .GetDataOutSrcReceiveFieldTitleByFormatID (FormatID).Tables[0];
