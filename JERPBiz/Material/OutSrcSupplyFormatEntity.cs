...
namespace JERPBiz.Material
{
    ...
    /// 2015/9/3 15:10:57
    ///</时间>  
    public class OutSrcSupplyFormatEntity
    {
        public OutSrcSupplyFormatEntity()
        {
            this.accData = new JERPData.Material.OutSrcSupplyFormat();
        }
        private JERPData.Material.OutSrcSupplyFormat accData;
        ...
        public string AssemblyColumnName = string.Empty;
        public int ItemRowIndex = -1;
        public int ItemRowCount = -1;
        public void LoadData(int FormatID)
        {
            this.FormatID = FormatID;
            DataTable dtbl = this.accData.GetDataOutSrcSupplyFormatByFormatID(FormatID).Tables[0];
            if (dtbl.Rows.Count == 0)
            {
                ...
                this.AssemblyColumnName = string.Empty;
                this.ItemRowIndex = -1;
                this.ItemRowCount = -1;
                return;
            }
            ...
            if (drow["AssemblyColumnName"] == DBNull.Value)
            {
                this.AssemblyColumnName = string.Empty;
            }
            else
            {
                this.AssemblyColumnName = drow["AssemblyColumnName"].ToString();
            }
