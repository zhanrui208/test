...
namespace JERPBiz.Material
{
    public class BuyReturnNotePrintHelper
    {
        public BuyReturnNotePrintHelper()
        {
            ...
            this.accFormatTitle = new JERPData.Material.BuyReturnFieldTitle();
            this.FormatEntity = new BuyReturnFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "MtrBuyReturnNote.xlt";
        ...
        private JERPData.Material.BuyReturnFormat accFormat;
        private JERPData.Material.BuyReturnFieldTitle accFormatTitle;
