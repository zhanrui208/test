...
namespace JERPBiz.Product
{
    public class BuyReceiveNotePrintHelper
    {
        public BuyReceiveNotePrintHelper()
        {
            ...
            this.accFormat = new JERPData.Product.BuyReceiveFormat();
            this.accFormatTitle = new JERPData.Product.BuyReceiveFieldTitle();
            this.FormatEntity = new BuyReceiveFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "PrdBuyReceiveNote.xlt";
         
            
        }
        private JERPBiz.Product .BuyReceiveNoteEntity   NoteEntity;
        private JERPData.Product.BuyReceiveItems accItems;
        private JERPData.Product.BuyReceiveFormat accFormat;
        private JERPData.Product.BuyReceiveFieldTitle accFormatTitle;
        ...
        public void ExportToExcel(long NoteID)
        {
            ...
            {
                string SettleTypeName =(this.NoteEntity .CashSettleFlag )? "现结":"月结";
                excel.SetCellVal(this.FormatEntity.SettleTypeCellName , SettleTypeName );
            }
