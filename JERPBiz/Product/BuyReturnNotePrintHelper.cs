...
namespace JERPBiz.Product
{
    public class BuyReturnNotePrintHelper
    {
        public BuyReturnNotePrintHelper()
        {
            ...
            this.accFormatTitle = new JERPData.Product.BuyReturnFieldTitle();
            this.FormatEntity = new BuyReturnFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "ProductBuyReturnNote.xlt";
        ...
        private JERPData.Product.BuyReturnFormat accFormat;
        private JERPData.Product.BuyReturnFieldTitle accFormatTitle;
