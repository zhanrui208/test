...
namespace JERPBiz.Product
{
    ...
    /// 2015/7/24 20:03:31
    ///</时间>  
    public class SaleInvoiceFormatEntity
    {
        public SaleInvoiceFormatEntity()
        {
            this.accData = new JERPData.Product.SaleInvoiceFormat();
        }
        private JERPData.Product.SaleInvoiceFormat accData;
        ...
        public void LoadData(int FormatID)
        {
            ...
            DataTable dtbl = this.accData.GetDataSaleInvoiceFormatByFormatID(FormatID).Tables[0];
