...
namespace JERPBiz.Product
{
    ...
    /// 2015/12/3 6:05:38
    ///</时间>  
    public class SalePriceNoteEntity
    {
        public SalePriceNoteEntity()
        {
            this.accData = new JERPData.Product.SalePriceNotes();
        }
        private JERPData.Product.SalePriceNotes accData;
        ...
        {
            this.NoteID = NoteID;
            DataTable dtbl = this.accData.GetDataSalePriceNotesByNoteID(NoteID).Tables[0];
