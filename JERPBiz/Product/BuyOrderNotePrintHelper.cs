...
namespace JERPBiz.Product
{
    public class BuyOrderNotePrintHelper
    {
        public BuyOrderNotePrintHelper()
        {
            ...
            this.accFormatTitle = new JERPData.Product.BuyOrderFieldTitle();
            this.FormatEntity = new BuyOrderFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "PrdBuyOrderNote.xlt";
        ...
        private JERPData.Product.BuyOrderFormat accFormat;
        private JERPData.Product.BuyOrderFieldTitle accFormatTitle;
