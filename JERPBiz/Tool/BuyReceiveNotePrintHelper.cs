...
namespace JERPBiz.Tool
{
    public class BuyReceiveNotePrintHelper
    {
        public BuyReceiveNotePrintHelper()
        {
            ...
            this.accFormatTitle = new JERPData.Tool.BuyReceiveFieldTitle();
            this.FormatEntity = new BuyReceiveFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "ToolBuyReceiveNote.xlt";
         
            
        }
        private JERPBiz.Tool .BuyReceiveNoteEntity   NoteEntity;
        private JERPData.Tool.BuyReceiveItems accItems;
        private JERPData.Tool.BuyReceiveFormat accFormat;
        private JERPData.Tool.BuyReceiveFieldTitle accFormatTitle;
