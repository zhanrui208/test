...
namespace JERPBiz.OtherRes
{
    public class BuyReceiveNotePrintHelper
    {
        public BuyReceiveNotePrintHelper()
        {
            ...
            this.accFormatTitle = new JERPData.OtherRes.BuyReceiveFieldTitle();
            this.FormatEntity = new BuyReceiveFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "OtherResBuyReceiveNote.xlt";
         
            
        }
        private JERPBiz.OtherRes .BuyReceiveNoteEntity   NoteEntity;
        private JERPData.OtherRes.BuyReceiveItems accItems;
        private JERPData.OtherRes.BuyReceiveFormat accFormat;
        private JERPData.OtherRes.BuyReceiveFieldTitle accFormatTitle;
