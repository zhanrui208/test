...
namespace JERPBiz.OtherRes
{
    public class BuyOrderNotePrintHelper
    {
        public BuyOrderNotePrintHelper()
        {
            ...
            this.accFormatTitle = new JERPData.OtherRes.BuyOrderFieldTitle();
            this.FormatEntity = new BuyOrderFormatEntity();
            this.TmpFileName = JERPData.ServerParameter.TempletFolder + "OtherResBuyOrderNote.xlt";
        ...
        private JERPData.OtherRes.BuyOrderFormat accFormat;
        private JERPData.OtherRes.BuyOrderFieldTitle accFormatTitle;
