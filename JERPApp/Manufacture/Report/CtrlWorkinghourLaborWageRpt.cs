...
{
    public partial class CtrlWorkinghourLaborWageRpt : UserControl
    {
        public CtrlWorkinghourLaborWageRpt()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            this.dtblReport = this.accWorkinghour.GetDataWorkinghourLaborWagePivotWorkinghourType(this.DateBegin ,this.DateEnd).Tables[0];
