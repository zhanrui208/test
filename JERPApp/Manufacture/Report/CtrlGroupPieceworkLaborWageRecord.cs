...
{
    public partial class CtrlGroupPieceworkLaborWageRecord : UserControl
    {
        public CtrlGroupPieceworkLaborWageRecord()
        {
            InitializeComponent();
            this.dgrdv.AutoGenerateColumns = false;
            this.dgrdv.ContextMenuStrip = this.cMenu;
            this.mItemRefresh.Click += new EventHandler(mItemRefresh_Click);
            this.accGroupPiecework = new JERPData.Manufacture.GroupPieceworkItems();
            this.btnExport .Click +=new EventHandler(btnExport_Click);
        }
        private JERPData.Manufacture.GroupPieceworkItems  accGroupPiecework;
        ...
        private void LoadData()
        {
            ...
            this.dtblReport = this.accGroupPiecework.GetDataGroupPieceworkItemsPsnLaborWagePivotProcessType (
                this.PsnID ,
                this.DateBegin ,
                this.DateEnd).Tables[0];
        ...
        void btnExport_Click(object sender, EventArgs e)
        {
            ...
            excel.SetCellVal("C1", this.PsnInfor + "[" + this.DateBegin.ToShortDateString() + "-" + this.DateEnd.ToShortDateString() + "]集体计件工资表");
            int rowIndex = 3;
            int colIndex = 1;
