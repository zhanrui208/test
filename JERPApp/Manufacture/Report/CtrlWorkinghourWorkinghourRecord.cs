...
{
    public partial class CtrlWorkinghourWorkinghourRecord : UserControl
    {
        public CtrlWorkinghourWorkinghourRecord()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            this.dtblReport = this.accWorkinghour.GetDataWorkinghourPsnWorkinghourPivotWorkinghourType(this.PsnID ,this.DateBegin ,this.DateEnd).Tables[0];
        ...
        void btnExport_Click(object sender, EventArgs e)
        {
            ...
            excel.SetCellVal("C1", this.PsnInfor + "[" + this.DateBegin.ToShortDateString() + "-" + this.DateEnd.ToShortDateString() + "]工时一览");
            int rowIndex = 3;
            int colIndex = 1;
