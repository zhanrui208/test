...
namespace JERPApp.Define.General
{
    ...
    /// 2014/5/30 15:25:33
    ///</时间> 
    public partial class CtrlSupplierForOutSrc : UserControl
    {
        public CtrlSupplierForOutSrc()
        {
            InitializeComponent();
        ...
        {
            this.dtblSupplier = this.accDataSupplier.GetDataSupplierForOutSrc().Tables[0];
