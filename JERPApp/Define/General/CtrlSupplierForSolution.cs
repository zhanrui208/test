...
namespace JERPApp.Define.General
{
    ...
    /// 2014/5/30 14:52:17
    ///</时间> 
    public partial class CtrlSupplierForSolution : UserControl
    {
        public CtrlSupplierForSolution()
        {
            InitializeComponent();
        ...
        {
            this.dtblSupplier = this.accDataSupplier.GetDataSupplierForSolution().Tables[0];
