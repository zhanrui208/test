...
namespace JERPApp.Define.General
{
    ...
    /// 2014/5/30 14:52:17
    ///</时间> 
    public partial class CtrlSupplierForMaterial : UserControl
    {
        public CtrlSupplierForMaterial()
        {
            InitializeComponent();
        ...
        {
            this.dtblSupplier = this.accDataSupplier.GetDataSupplierForMaterial().Tables[0];
