...
namespace JERPApp.Define.General
{
    ...
    /// 2014/5/30 14:52:17
    ///</时间> 
    public partial class CtrlSupplierForProduct : UserControl
    {
        public CtrlSupplierForProduct()
        {
            InitializeComponent();
        ...
        {
            this.dtblSupplier = this.accDataSupplier.GetDataSupplierForProduct().Tables[0];
