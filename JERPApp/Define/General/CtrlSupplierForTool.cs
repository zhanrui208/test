...
namespace JERPApp.Define.General
{
    ...
    /// 2014/5/30 14:52:17
    ///</时间> 
    public partial class CtrlSupplierForTool : UserControl
    {
        public CtrlSupplierForTool()
        {
            InitializeComponent();
        ...
        {
            this.dtblSupplier = this.accDataSupplier.GetDataSupplierForTool().Tables[0];
