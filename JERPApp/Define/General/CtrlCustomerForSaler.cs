...
namespace JERPApp.Define.General
{
    ...
    /// 2014/3/27 9:46:00
    ///</时间> 
    public partial class CtrlCustomerForSaler : UserControl
    {
        public CtrlCustomerForSaler()
        {
            InitializeComponent();
        ...
        {
            this.dtblCustomer = this.accDataCustomer.GetDataCustomerBySalePsnID (JERPBiz .Frame .UserBiz .PsnID ).Tables[0];
