...
{
    public partial class CtrlPrdTypeProfit : UserControl
    {
        public CtrlPrdTypeProfit()
        {
            InitializeComponent();
        ...
        {
            this.Year = Year;
            this.dtblReport = this.accItems.GetDataSaleDeliverItemsPrdTypeProfitPivotMonth (Year).Tables[0];
        ...
        void dgrdv_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.dgrdv.Columns[icol].GetType().Equals(typeof(DataGridViewLinkColumn)))
            {
                ...
                if (PrdTypeID > -1)
                {
                    whereclause += " and (PrdTypeID=" + PrdTypeID.ToString() + ")";
                    whereinfor += ",产品类型[" + drow["PrdTypeName"].ToString() +"]";
                }
        ...
        void btnExport_Click(object sender, EventArgs e)
        {
            ...
            excel.SetCellVal("D1", this.Year.ToString() + "年类型毛利表");
            int rowIndex = 3;
            int colIndex = 1;
