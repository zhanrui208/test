...
{
    public partial class CtrlMtrBuyReconciliationRpt : UserControl
    {
        public CtrlMtrBuyReconciliationRpt()
        {
            InitializeComponent();
            this.dgrdv.AutoGenerateColumns = false;
            this.accReconcilaiton = new JERPData.Material.BuyReconciliations();
        ...
        private JERPData.Material.BuyReconciliations accReconcilaiton;
        ...
        void btnExplore_Click(object sender, EventArgs e)
        {
            ...
            excel.SetCellVal("A1", Year.ToString() + "年原料对账表");
            int rowIndex = 4;
            int colIndex = 1;
