...
{
    public partial class CtrlPostageReconciliationRpt : UserControl
    {
        public CtrlPostageReconciliationRpt()
        {
            InitializeComponent();
            this.dgrdv.AutoGenerateColumns = false;
            this.accReconcilaiton = new JERPData.Finance.PostageReconciliations();
        ...
        private JERPData.Finance.PostageReconciliations accReconcilaiton;
        ...
        {
            this.dtblRpt = this.accReconcilaiton.GetDataPostageReconciliationsYearReport (this.Year).Tables[0];
        ...
        void btnExplore_Click(object sender, EventArgs e)
        {
            ...
            excel.SetCellVal("A1", Year.ToString() + "年运费对账表");
            int rowIndex = 4;
            int colIndex = 1;
