...
namespace JERPApp.Finance.Payable.Product
{
    public partial class CtrlReceiveNoteReconciliationOper : UserControl
    {
        public CtrlReceiveNoteReconciliationOper()
        {
            ...
            this.accReceiveNotes = new JERPData.Product.BuyReceiveNotes();
        ...
        private JERPData.Product.BuyReceiveNotes accReceiveNotes;
        private JERPData.Product.BuyOrderItems accOrderItems;
        private JERPApp.Store.Product .Report.Bill.FrmBuyReceiveNote frmDetail;
